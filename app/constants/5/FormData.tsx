...
const TEAM_5_FORM_ANSWER_1 = [
    0, 1, 4, 5
]

const TEAM_5_FORM_ANSWER_2 = [
    0, 1, 3, 4, 7, 8
]

const TEAM_5_FORM_ANSWER_3 = [
    1, 2, 3, 4, 5, 8
]

const TEAM_5_FORM_ANSWER_4 = [
    1, 2, 3, 5, 6
]

const TEAM_5_FORM_ANSWER_5 = [
    2, 6, 7
]
const TEAM_5_FORM_ANSWER_6 = [
    0, 3, 4, 6
]
const TEAM_5_FORM = {
    data1: TEAM_5_FORM_DATA_1,
    data2: TEAM_5_FORM_DATA_2,
    data3: TEAM_5_FORM_DATA_3,
    data4: TEAM_5_FORM_DATA_4,
    data5: TEAM_5_FORM_DATA_5,
    data6: TEAM_5_FORM_DATA_6,

    answer1: TEAM_5_FORM_ANSWER_1,
    answer2: TEAM_5_FORM_ANSWER_2,
    answer3: TEAM_5_FORM_ANSWER_3,
    answer4: TEAM_5_FORM_ANSWER_4,
    answer5: TEAM_5_FORM_ANSWER_5,
    answer6: TEAM_5_FORM_ANSWER_6
}
